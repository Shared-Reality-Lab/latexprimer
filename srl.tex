...
% Put things in \hide{this text is hidden!} to make sure they don't appear ever!
\newcommand{\hide}[1]{}
...
\else
    ...
    %and your own color here if there is no good built-in color...use something that doesn't print too light...
